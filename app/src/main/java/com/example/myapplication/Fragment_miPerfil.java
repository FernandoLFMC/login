...
public class Fragment_miPerfil extends Fragment {
    View view;
    TextView textViewNombre,textViewEmail,textViewTelefono,textViewSexo,textViewDireccion,textViewTipo, textViewMGusta, textViewNGusta;
    EditText editTextNombre, editTextTelefono, editTextDireccion;
    ImageView avatar;
    Button btnGuardar;
    ...
    private void actualizarDatos() {
        ...
        if (editTextTelefono.getText().toString().isEmpty()|| editTextNombre.getText().toString().isEmpty() || editTextDireccion.getText().toString().isEmpty()){
    ...
    private void setData(JSONObject response) {
        try {
            ...
            editTextDireccion.setText(response.getString("direccion"));
